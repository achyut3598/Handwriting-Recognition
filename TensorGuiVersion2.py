...
class TensorReaderGui(tk.Tk): #GUI using Tkinter for program
    ...
    def dig_results(self,myoutlabel,myinlabel): #Shows results from tensorflow on that digit file
        ...
        mystring = "D:/School/PythonFinalProj/" + myinlabel #File Path should be updated!
...
class HomePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        alphbutton = tk.Button(self, text="Read a pre-selected Alphabetical Character", command=lambda: controller.show_frame("AlphaPage")) #Opens Alpha Page
        alphbutton.pack(side=TOP, fill=X, expand=YES)
...
class AlphaPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        cycleleft = tk.Button(self, text="<", command=lambda: controller.prev_alph(myfilelabel)) #Changes left
        cycleleft.pack(side=LEFT, fill=X, expand=YES)
        
        readbutton = tk.Button(self, text="Read", command=lambda: controller.alph_results(myresultslabel)) #Runs file thorugh tensorflow
        readbutton.pack(side=LEFT, fill=X, expand=YES)
        
        cycleright = tk.Button(self, text=">", command=lambda: controller.next_alph(myfilelabel)) #Changes right
        cycleright.pack(side=LEFT, fill=X, expand=YES)
...
class UserPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        alphbutton = tk.Button(self, text="Read Alphabetical Character") #Runs file thorugh tensorflow
        alphbutton.pack(side=LEFT, anchor=W, fill=X, expand=YES)
...
def main(_):
  ...
  image = imageprepare(mystring)
  print(prediction.eval(feed_dict = {x: [image]}, session = sess))     
